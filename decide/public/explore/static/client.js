(() => {
  ...
  function _(l5, u4, t3) {
    ...
    if (
      (arguments.length > 2 &&
        (f3.children = arguments.length > 3 ? n.call(arguments, 2) : t3),
      "function" == typeof l5 && null != l5.defaultProps)
    )
      for (r4 in l5.defaultProps)
        void 0 === f3[r4] && (f3[r4] = l5.defaultProps[r4]);
  ...
  function x(n2, l5) {
    ...
    for (var u4; l5 < n2.__k.length; l5++)
      if (null != (u4 = n2.__k[l5]) && null != u4.__e) return u4.__e;
    return "function" == typeof n2.type ? x(n2) : null;
  }
  function C(n2) {
    var l5, u4;
    if (null != (n2 = n2.__) && null != n2.__c) {
      for (n2.__e = n2.__c.base = null, l5 = 0; l5 < n2.__k.length; l5++)
        if (null != (u4 = n2.__k[l5]) && null != u4.__e) {
  ...
  function M(n2) {
    ((!n2.__d && (n2.__d = true) && i.push(n2) && !P.__r++) ||
  ...
  function S(n2, l5, u4, t3, i4, o3, r4, f3, e3, c5, s5) {
    var a5,
      ...
      _3 = (t3 && t3.__k) || p,
      g3 = l5.length;
    for (u4.__d = e3, $(u4, l5, _3), e3 = u4.__d, a5 = 0; a5 < g3; a5++)
      null != (y4 = u4.__k[a5]) &&
        "boolean" != typeof y4 &&
        "function" != typeof y4 &&
        ((v4 = -1 === y4.__i ? h : _3[y4.__i] || h),
        (y4.__i = a5),
        O(n2, y4, v4, i4, o3, r4, f3, e3, c5, s5),
        (d4 = y4.__e),
        y4.ref &&
          v4.ref != y4.ref &&
          (v4.ref && N(v4.ref, null, y4), s5.push(y4.ref, y4.__c || d4, y4)),
        null == w4 && null != d4 && (w4 = d4),
        65536 & y4.__u || v4.__k === y4.__k
          ? (e3 && !e3.isConnected && (e3 = x(v4)), (e3 = I(y4, e3, n2)))
          : "function" == typeof y4.type && void 0 !== y4.__d
          ? (e3 = y4.__d)
          : d4 && (e3 = d4.nextSibling),
        (y4.__d = void 0),
        (y4.__u &= -196609));
    (u4.__d = e3), (u4.__e = w4);
  }
      ...
      (r4 = t3 + a5),
        ...
        (i4 = n2.__k[t3] =
          ...
          "function" == typeof i4
            ...
            : y(i4)
            ? g(k, { children: i4 }, null, null, null)
          ...
          ? ((i4.__ = n2),
            ...
            (i4.__i = f3),
            (o3 = null),
            -1 !== f3 && (s5--, (o3 = u4[f3]) && (o3.__u |= 131072)),
            null == o3 || null === o3.__v
              ? (-1 == f3 && a5--,
              ...
              : f3 !== r4 &&
                (f3 === r4 + 1
                  ...
                  ? f3 == r4 - 1 && (a5 = f3 - r4)
                  : (a5 = 0),
                f3 !== t3 + a5 && (i4.__u |= 65536)))
          : (o3 = u4[r4]) &&
            null == o3.key &&
            o3.__e &&
            0 == (131072 & o3.__u) &&
            (o3.__e == n2.__d && (n2.__d = x(o3)),
            V(o3, o3, false),
            (u4[r4] = null),
            s5--);
    if (s5)
  ...
  function I(n2, l5, u4) {
    ...
    if ("function" == typeof n2.type) {
      for (t3 = n2.__k, i4 = 0; t3 && i4 < t3.length; i4++)
        t3[i4] && ((t3[i4].__ = n2), (l5 = I(t3[i4], l5, u4)));
      return l5;
    }
  ...
  function L(n2, l5, u4, t3) {
    ...
    if (
      null === e3 ||
      (e3 && i4 == e3.key && o3 === e3.type && 0 == (131072 & e3.__u))
    )
      return u4;
    if (t3 > (null != e3 && 0 == (131072 & e3.__u) ? 1 : 0))
      for (; r4 >= 0 || f3 < l5.length; ) {
        if (r4 >= 0) {
          if (
            (e3 = l5[r4]) &&
            0 == (131072 & e3.__u) &&
  ...
  function T(n2, l5, u4) {
    "-" === l5[0]
      ? n2.setProperty(l5, null == u4 ? "" : u4)
      : (n2[l5] =
          null == u4
            ? ""
            : "number" != typeof u4 || v.test(l5)
            ? u4
            : u4 + "px");
  }
    ...
    n: if ("style" === l5)
      if ("string" == typeof u4) n2.style.cssText = u4;
        ...
        if (("string" == typeof t3 && (n2.style.cssText = t3 = ""), t3))
          for (l5 in t3) (u4 && l5 in u4) || T(n2.style, l5, "");
        if (u4)
          for (l5 in u4) (t3 && u4[l5] === t3[l5]) || T(n2.style, l5, u4[l5]);
      }
    else if ("o" === l5[0] && "n" === l5[1])
      (o3 = l5 !== (l5 = l5.replace(/(PointerCapture)$|Capture$/i, "$1"))),
        (l5 =
          l5.toLowerCase() in n2 || "onFocusOut" === l5 || "onFocusIn" === l5
            ? l5.toLowerCase().slice(2)
            : l5.slice(2)),
        n2.l || (n2.l = {}),
        (n2.l[l5 + o3] = u4),
        u4
          ? t3
            ? (u4.u = t3.u)
            : ((u4.u = e), n2.addEventListener(l5, o3 ? s : c, o3))
          : n2.removeEventListener(l5, o3 ? s : c, o3);
    else {
      ...
      "function" == typeof u4 ||
        (null == u4 || (false === u4 && "-" !== l5[4])
          ? n2.removeAttribute(l5)
          : n2.setAttribute(l5, u4));
    }
  }
  function F(n2) {
    return function (u4) {
  ...
  function O(n2, u4, t3, i4, o3, r4, f3, e3, c5, s5) {
    ...
    128 & t3.__u && ((c5 = !!(32 & t3.__u)), (r4 = [(e3 = u4.__e = t3.__e)])),
      (a5 = l.__b) && a5(u4);
    n: if ("function" == typeof L2)
      try {
        if (
          ((m3 = u4.props),
          (x3 = (a5 = L2.contextType) && i4[a5.__c]),
          (C3 = a5 ? (x3 ? x3.props.value : a5.__) : i4),
          t3.__c
            ? (g3 = (h4 = u4.__c = t3.__c).__ = h4.__E)
            : ("prototype" in L2 && L2.prototype.render
                ? (u4.__c = h4 = new L2(m3, C3))
                : ((u4.__c = h4 = new b(m3, C3)),
                  (h4.constructor = L2),
                  (h4.render = q)),
              x3 && x3.sub(h4),
              (h4.props = m3),
              ...
              (h4.__h = []),
              (h4._sb = [])),
          null == h4.__s && (h4.__s = h4.state),
          null != L2.getDerivedStateFromProps &&
            (h4.__s == h4.state && (h4.__s = d({}, h4.__s)),
            d(h4.__s, L2.getDerivedStateFromProps(m3, h4.__s))),
          (v4 = h4.props),
          (w4 = h4.state),
          (h4.__v = u4),
          p5)
          ...
          null == L2.getDerivedStateFromProps &&
            null != h4.componentWillMount &&
            h4.componentWillMount(),
            null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
        else {
          if (
            (null == L2.getDerivedStateFromProps &&
              m3 !== v4 &&
              null != h4.componentWillReceiveProps &&
              h4.componentWillReceiveProps(m3, C3),
            !h4.__e &&
              ((null != h4.shouldComponentUpdate &&
                false === h4.shouldComponentUpdate(m3, h4.__s, C3)) ||
                u4.__v === t3.__v))
          ) {
            for (
              u4.__v !== t3.__v &&
                ((h4.props = m3), (h4.state = h4.__s), (h4.__d = false)),
                u4.__e = t3.__e,
                u4.__k = t3.__k,
          ...
          null != h4.componentWillUpdate &&
            h4.componentWillUpdate(m3, h4.__s, C3),
            null != h4.componentDidUpdate &&
              h4.__h.push(function () {
        ...
        if (
          ...
          for (
            h4.state = h4.__s,
              h4.__d = false,
              P3 && P3(u4),
              a5 = h4.render(h4.props, h4.state, h4.context),
              I3 = 0;
            I3 < h4._sb.length;
            I3++
          )
            h4.__h.push(h4._sb[I3]);
          h4._sb = [];
        } else
          do {
            (h4.__d = false),
        ...
        (h4.state = h4.__s),
          null != h4.getChildContext &&
            (i4 = d(d({}, i4), h4.getChildContext())),
          p5 ||
            null == h4.getSnapshotBeforeUpdate ||
            (_3 = h4.getSnapshotBeforeUpdate(v4, w4)),
          S(
            n2,
            y(
              (H2 =
                null != a5 && a5.type === k && null == a5.key
                  ? a5.props.children
                  : a5)
            )
              ? H2
          ...
          g3 && (h4.__E = h4.__ = null);
      } catch (n3) {
        (u4.__v = null),
          c5 || null != r4
            ? ((u4.__e = e3),
              (u4.__u |= c5 ? 160 : 32),
              (r4[r4.indexOf(e3)] = null))
            : ((u4.__e = t3.__e), (u4.__k = t3.__k)),
          l.__e(n3, u4, t3);
      }
    else
      null == r4 && u4.__v === t3.__v
        ? ((u4.__k = t3.__k), (u4.__e = t3.__e))
        : (u4.__e = z(t3.__e, u4, t3, i4, o3, r4, f3, c5, s5));
    (a5 = l.diffed) && a5(u4);
  }
  function j(n2, u4, t3) {
    u4.__d = void 0;
  ...
  function z(l5, u4, t3, i4, o3, r4, f3, e3, c5) {
    ...
    if (
      ...
      for (s5 = 0; s5 < r4.length; s5++)
        if (
          (d4 = r4[s5]) &&
          "setAttribute" in d4 == !!b3 &&
          (b3 ? d4.localName === b3 : 3 === d4.nodeType)
        ) {
          (l5 = d4), (r4[s5] = null);
          break;
        }
    ...
    if (null == l5) {
      ...
      (l5 = document.createElementNS(o3, b3, k4.is && k4)),
        (r4 = null),
        (e3 = false);
    }
    if (null === b3) m3 === k4 || (e3 && l5.data === k4) || (l5.data = k4);
      ...
      if (
        ((r4 = r4 && n.call(l5.childNodes)),
        (m3 = t3.props || h),
        !e3 && null != r4)
      )
        for (m3 = {}, s5 = 0; s5 < l5.attributes.length; s5++)
          m3[(d4 = l5.attributes[s5]).name] = d4.value;
      for (s5 in m3)
        if (((d4 = m3[s5]), "children" == s5));
        else if ("dangerouslySetInnerHTML" == s5) p5 = d4;
        else if ("key" !== s5 && !(s5 in k4)) {
          if (
            ("value" == s5 && "defaultValue" in k4) ||
            ("checked" == s5 && "defaultChecked" in k4)
          )
            continue;
          A(l5, s5, null, d4, o3);
        }
      for (s5 in k4)
        (d4 = k4[s5]),
          "children" == s5
            ...
            ? (g3 = d4)
            : "key" === s5 ||
              (e3 && "function" != typeof d4) ||
              m3[s5] === d4 ||
              A(l5, s5, d4, m3[s5], o3);
      if (a5)
        e3 ||
          (p5 && (a5.__html === p5.__html || a5.__html === l5.innerHTML)) ||
          (l5.innerHTML = a5.__html),
          (u4.__k = []);
      else if (
        (p5 && (l5.innerHTML = ""),
        S(
          ...
          t3,
          i4,
          "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o3,
          r4,
          f3,
          r4 ? r4[0] : t3.__k && x(t3, 0),
          e3,
          c5
        ),
        null != r4)
      )
        for (s5 = r4.length; s5--; ) null != r4[s5] && w(r4[s5]);
      e3 ||
        ((s5 = "value"),
        void 0 !== _3 &&
          (_3 !== l5[s5] ||
          ...
          A(l5, s5, _3, m3[s5], o3),
        (s5 = "checked"),
        void 0 !== g3 && g3 !== l5[s5] && A(l5, s5, g3, m3[s5], o3));
    }
    return l5;
  }
  function N(n2, u4, t3) {
  ...
  function V(n2, u4, t3) {
    ...
    if (
      ...
      (i4 = n2.ref) &&
        ((i4.current && i4.current !== n2.__e) || N(i4, null, u4)),
      null != (i4 = n2.__c))
    ) {
    ...
    t3 || null == n2.__e || w(n2.__e),
      (n2.__c = n2.__ = n2.__e = n2.__d = void 0);
  }
  function q(n2, l5, u4) {
  ...
  function B(u4, t3, i4) {
    var o3, r4, f3, e3;
    l.__ && l.__(u4, t3),
      (r4 = (o3 = "function" == typeof i4) ? null : (i4 && i4.__k) || t3.__k),
      (f3 = []),
      (e3 = []),
      O(
        t3,
        (u4 = ((!o3 && i4) || t3).__k = _(k, null, [u4])),
        r4 || h,
        h,
        t3.namespaceURI,
        !o3 && i4
          ...
          : null,
        f3,
        !o3 && i4 ? i4 : r4 ? r4.__e : t3.firstChild,
        o3,
        e3
      ),
      j(f3, u4, e3);
  ...
  function E(l5, u4, t3) {
    var i4,
      ...
      f3,
      e3 = d({}, l5.props);
    for (r4 in (l5.type && l5.type.defaultProps && (f3 = l5.type.defaultProps),
    u4))
      "key" == r4
        ? (i4 = u4[r4])
        : "ref" == r4
        ? (o3 = u4[r4])
        : (e3[r4] = void 0 === u4[r4] && void 0 !== f3 ? f3[r4] : u4[r4]);
    return (
      arguments.length > 2 &&
        (e3.children = arguments.length > 3 ? n.call(arguments, 2) : t3),
      g(l5.type, e3, i4 || l5.key, o3 || l5.ref, null)
    );
  }
  function G(n2, l5) {
    var u4 = {
  ...
  (n = p.slice),
    (l = {
      __e: function (n2, l5, u4, t3) {
        for (var i4, o3, r4; (l5 = l5.__); )
          if ((i4 = l5.__c) && !i4.__)
            try {
              if (
                ((o3 = i4.constructor) &&
                  null != o3.getDerivedStateFromError &&
                  (i4.setState(o3.getDerivedStateFromError(n2)), (r4 = i4.__d)),
                null != i4.componentDidCatch &&
                  (i4.componentDidCatch(n2, t3 || {}), (r4 = i4.__d)),
                r4)
              )
                return (i4.__E = i4);
            } catch (l6) {
    ...
    (b.prototype.setState = function (n2, l5) {
      ...
      (u4 =
        ...
        n2 && d(u4, n2),
        null != n2 && this.__v && (l5 && this._sb.push(l5), M(this));
    }),
  ...
  function s2() {
    var o3 = new CustomEvent("_preact", {
      detail: {},
      bubbles: true,
      cancelable: true,
    });
    this.dispatchEvent(o3),
      (this._vdom = _(
        a2,
        r2({}, this._props, { context: o3.detail.context }),
        (function e3(n2, o4) {
          ...
          for (a5 = s5.length; a5--; )
            "slot" !== s5[a5].name &&
              ((i4[s5[a5].name] = s5[a5].value),
              (i4[c2(s5[a5].name)] = s5[a5].value));
          for (a5 = l5.length; a5--; ) {
            var u4 = e3(l5[a5], null),
              d4 = l5[a5].slot;
  ...
  function l2(t3, e3, r4) {
    if (this._vdom) {
      var i4 = {};
      (i4[t3] = r4 = null == r4 ? void 0 : r4),
        (i4[c2(t3)] = r4),
        (this._vdom = E(this._vdom, i4)),
        B(this._vdom, this._root);
    }
  }
  function u2() {
      ...
      r2({}, e3, {
        ref: function (t3) {
          t3
            ? ((o3.ref = t3),
              o3._listener ||
                ((o3._listener = function (t4) {
                  t4.stopPropagation(), (t4.detail.context = n2);
                }),
                t3.addEventListener("_preact", o3._listener)))
            : o3.ref.removeEventListener("_preact", o3._listener);
        },
      })
    );
  }
  function preact_custom_element_esm_default(t3, e3, n2, o3) {
    function r4() {
      ...
      return (
        (e4._vdomComponent = t3),
        (e4._root =
          o3 && o3.shadow ? e4.attachShadow({ mode: o3.mode || "open" }) : e4),
        e4
      );
    }
    return (
      ((r4.prototype = Object.create(HTMLElement.prototype)).constructor = r4),
      (r4.prototype.connectedCallback = s2),
      (r4.prototype.attributeChangedCallback = l2),
      (r4.prototype.disconnectedCallback = u2),
      (n2 = n2 || t3.observedAttributes || Object.keys(t3.propTypes || {})),
      (r4.observedAttributes = n2),
      n2.forEach(function (t4) {
        Object.defineProperty(r4.prototype, t4, {
          ...
          set: function (e4) {
            this._vdom
              ? this.attributeChangedCallback(t4, null, e4)
  ...
  var result = {
    navigation: "ex_navigation--h1138",
    list: "ex_list--hf58f",
    item: "ex_item--hab80",
  };
  ...
  var Navigation = () => {
    return /* @__PURE__ */ _(
      "nav",
      { class: Navigation_default.navigation },
      /* @__PURE__ */ _(
        "ul",
        { class: Navigation_default.list },
        /* @__PURE__ */ _(
          "li",
          { class: Navigation_default.item },
          /* @__PURE__ */ _("a", { href: "/products" }, "Machines")
        ),
        /* @__PURE__ */ _(
          "li",
          { class: Navigation_default.item },
          /* @__PURE__ */ _("a", { href: "/stores" }, "Stores")
        )
      )
    );
  };
  ...
  var result2 = {
    header: "ex_header--he236",
    cutter: "ex_cutter--he77d",
    inner: "ex_inner--h0d78",
    logo: "ex_logo--hd0fd",
    link: "ex_link--h0153",
    cart: "ex_cart--h271c",
    navigation: "ex_navigation--heaed",
  };
  ...
  var Header_default2 = () => {
    return /* @__PURE__ */ _(
      "header",
      { class: Header_default.header, "data-boundary": "explore-header" },
      /* @__PURE__ */ _("link", {
        rel: "stylesheet",
        href: "/explore/static/client.css",
      }),
      /* @__PURE__ */ _(
        "div",
        { class: Header_default.cutter },
        /* @__PURE__ */ _(
          "div",
          { class: Header_default.inner },
          /* @__PURE__ */ _(
            "a",
            { class: Header_default.link, href: "/" },
            /* @__PURE__ */ _("img", {
          ...
          /* @__PURE__ */ _(
            "div",
            { class: Header_default.navigation },
            /* @__PURE__ */ _(Navigation_default2, null)
          ),
          /* @__PURE__ */ _(
            "div",
            { class: Header_default.cart },
            /* @__PURE__ */ _(Fragment_default, {
              team: "checkout",
              name: "minicart",
            })
          )
  ...
  var result3 = {
    footer: "ex_footer--hd453",
    cutter: "ex_cutter--ha57a",
    inner: "ex_inner--h5b70",
    initiative: "ex_initiative--h613b",
    credits: "ex_credits--h7878",
  };
  ...
  var Footer_default2 = () => {
    return /* @__PURE__ */ _(
      "footer",
      { class: Footer_default.footer, "data-boundary": "explore-footer" },
      /* @__PURE__ */ _("link", {
        rel: "stylesheet",
        href: "/explore/static/client.css",
      }),
      /* @__PURE__ */ _(
        "div",
        { class: Footer_default.cutter },
        /* @__PURE__ */ _(
          "div",
          { class: Footer_default.inner },
          /* @__PURE__ */ _(
            "div",
            { class: Footer_default.initiative },
            /* @__PURE__ */ _("img", {
            ...
            /* @__PURE__ */ _(
              ...
              /* @__PURE__ */ _(
                "a",
                { href: "https://neuland-bfi.de", target: "_blank" },
                "neuland"
              ),
              " ",
              "project"
          ...
          /* @__PURE__ */ _(
            "div",
            { class: Footer_default.credits },
            /* @__PURE__ */ _("h4", null, "techstack"),
            /* @__PURE__ */ _(
              "p",
              null,
              "ssr, esi, custom elements, declarative shadow dom, preact, css-modules, mpa, no app shell"
            ),
            /* @__PURE__ */ _(
              "p",
              null,
  ...
  var result4 = {
    recommendation: "ex_recommendation--h1b1b",
    link: "ex_link--hc05f",
    image: "ex_image--hffa9",
    name: "ex_name--he718",
  };
  ...
  var Recommendation_default2 = ({ image, url, name }) => {
    return /* @__PURE__ */ _(
      "li",
      { class: Recommendation_default.recommendation },
      /* @__PURE__ */ _(
        "a",
        { class: Recommendation_default.link, href: url },
        /* @__PURE__ */ _("img", {
  ...
  var result5 = {
    recommendations: "ex_recommendations--h81ff",
    list: "ex_list--h7801",
  };
  ...
  var Recommendations = ({ recommendations }) => {
    return recommendations.length
      ? /* @__PURE__ */ _(
          "div",
          {
            class: Recommendations_default.recommendations,
          ...
          /* @__PURE__ */ _("h2", null, "Recommendations"),
          /* @__PURE__ */ _(
            "ul",
            { class: Recommendations_default.list },
            recommendations.map(Recommendation_default2)
          )
        )
      : null;
  };
  ...
  function y2(n2, u4, i4) {
    ...
    if (
      ...
      r3.u = true;
      var c5 = r3.shouldComponentUpdate,
        e3 = r3.componentWillUpdate;
  ...
  function _2(n2, u4) {
    ...
    !e2.__s &&
      C2(i4.__H, u4) &&
      ((i4.__ = n2), (i4.i = u4), r3.__H.__h.push(i4));
  }
  function F2(n2) {
    return (
      (o2 = 5),
  ...
  function q2(n2, r4) {
    var u4 = h2(t2++, 7);
    return C2(u4.__H, r4)
      ? ((u4.__V = n2()), (u4.i = r4), (u4.__h = n2), u4.__V)
      : u4.__;
  }
  function x2(n2, t3) {
    return (
  ...
  (e2.__b = function (n2) {
    ...
    (e2.diffed = function (n2) {
      ...
      t3 &&
        t3.__H &&
        (t3.__H.__h.length &&
          ((1 !== f2.push(t3) && i3 === e2.requestAnimationFrame) ||
            ((i3 = e2.requestAnimationFrame) || w2)(j2)),
        t3.__H.__.forEach(function (n3) {
          n3.i && (n3.__H = n3.i),
            n3.__V !== c3 && (n3.__ = n3.__V),
            (n3.i = void 0),
            (n3.__V = c3);
        })),
        (u3 = r3 = null);
  ...
  var RecommendationsCe = ({ skus }, initialState) => {
    ...
    _2(async () => {
      ...
      if (!skus) return;
      const data = await fetchData_default(Recommendations_default2.api, {
        skus,
      });
      setState(data);
    }, [skus]);
  ...
  function s4(n2, t3, r4) {
    ...
    if (e3 && e3[1])
      for (var f3 = e3[1].split("&"), c5 = 0; c5 < f3.length; c5++) {
        var s5 = f3[c5].split("=");
        u4[decodeURIComponent(s5[0])] = decodeURIComponent(
          s5.slice(1).join("=")
        );
      }
  ...
  function l4(n2) {
    return ":" == n2.charAt(0)
      ? 1 + "*+?".indexOf(n2.charAt(n2.length - 1)) || 4
      : 5;
  }
  var p4 = {};
  var m2 = [];
  ...
  function $2(n2, t3) {
    return (
      void 0 === t3 && (t3 = false),
      "string" != typeof n2 && n2.url && ((t3 = n2.replace), (n2 = n2.url)),
      (function (n3) {
          ...
          void 0 === t4 && (t4 = "push"),
            U && U[t4]
              ...
              : "undefined" != typeof history &&
                history[t4 + "State"] &&
                history[t4 + "State"](null, null, n3);
        })(n2, t3 ? "replace" : "push"),
      I2(n2)
    );
  }
  function I2(n2) {
    for (var t3 = false, r4 = 0; r4 < m2.length; r4++)
      m2[r4].routeTo(n2) && (t3 = true);
    return t3;
  }
  function M2(n2) {
    if (n2 && n2.getAttribute) {
      var t3 = n2.getAttribute("href"),
        r4 = n2.getAttribute("target");
      if (t3 && t3.match(/^\//g) && (!r4 || r4.match(/^_?self$/i)))
        return $2(t3);
    }
  }
  function b2(n2) {
    return (
      n2.stopImmediatePropagation && n2.stopImmediatePropagation(),
  ...
  c4((D3.prototype = new b()), {
    shouldComponentUpdate: function (n2) {
      return (
        true !== n2.static ||
        n2.url !== this.props.url ||
        n2.onChange !== this.props.onChange
      );
    },
    ...
    g: function (n2, t3) {
      ...
      for (var r4 = 0; r4 < n2.length; r4++) {
        var i4 = n2[r4],
          o3 = s4(t3, i4.props.path, i4.props);
        if (o3) return [i4, o3];
      }
    },
    render: function (n2, t3) {
      var e3,
        ...
        a5 = t3.url,
        s5 = this.c,
        h4 = this.g(H(n2.children), a5);
      if (
        (h4 &&
          (u4 = E(
            h4[0],
            c4(c4({ url: a5, matches: (e3 = h4[1]) }, e3), {
              key: void 0,
              ref: void 0,
            })
          )),
  ...
  var Filter_default2 = ({ filters }) => {
    return /* @__PURE__ */ _(
      ...
      /* @__PURE__ */ _(
        ...
        filters.map((f3) =>
          f3.active
            ? /* @__PURE__ */ _("li", { class: Filter_default.active }, f3.name)
            : /* @__PURE__ */ _(
                "li",
                null,
                /* @__PURE__ */ _("a", { href: f3.url }, f3.name)
              )
        )
      )
    );
  ...
  var result7 = {
    product: "ex_product--h2174",
    link: "ex_link--h1ba3",
    image: "ex_image--h4919",
    name: "ex_name--h86d8",
    price: "ex_price--hda46",
  };
  ...
  var Product_default2 = ({ name, url, image, startPrice }) => {
    return /* @__PURE__ */ _(
      "li",
      { class: Product_default.product },
      /* @__PURE__ */ _(
        "a",
        { class: Product_default.link, href: url },
        /* @__PURE__ */ _("img", {
        ...
        /* @__PURE__ */ _("span", { class: Product_default.name }, name),
        /* @__PURE__ */ _(
          "span",
          { class: Product_default.price },
          fmtprice(startPrice)
        )
      )
    );
  ...
  var CategoryPage = ({ title = "", products = [], filters = [] }) => {
    return /* @__PURE__ */ _(
      "main",
      { class: CategoryPage_default.page },
      /* @__PURE__ */ _("h2", null, title),
      /* @__PURE__ */ _(
        "div",
        { class: CategoryPage_default.subline },
        /* @__PURE__ */ _("p", null, products.length, " products"),
        /* @__PURE__ */ _(Filter_default2, { filters })
      ),
      /* @__PURE__ */ _(
        "ul",
        { class: CategoryPage_default.list },
        products.map(Product_default2)
      )
    );
  };
  ...
  var result9 = {
    page: "ex_page--h6487",
    categoryLink: "ex_categoryLink--he75e",
    recommendations: "ex_recommendations--h3b3a",
  };
  ...
  var HomePage = ({ teaser = [] }) => {
    return /* @__PURE__ */ _(
      "main",
      { class: HomePage_default.page },
      teaser.map(({ title, image, url }) =>
        /* @__PURE__ */ _(
          "a",
          { class: HomePage_default.categoryLink, href: url },
          /* @__PURE__ */ _("img", {
            src: src(image, 500),
      ...
      /* @__PURE__ */ _(
        "div",
        { class: HomePage_default.recommendations },
        /* @__PURE__ */ _(Fragment_default, {
          team: "explore",
  ...
  var StoresPage = ({ stores = [] }) => {
    return /* @__PURE__ */ _(
      "main",
      { class: StoresPage_default.page },
      /* @__PURE__ */ _("h2", null, "Our Stores"),
      /* @__PURE__ */ _(
        "p",
        null,
      ...
      /* @__PURE__ */ _(
        "ul",
        { class: StoresPage_default.list },
        stores.map(Store_default)
      )
    );
  };
  ...
  var App = ({ path, data }) => {
    ...
    return /* @__PURE__ */ _(
      "div",
      { "data-boundary": "explore-page" },
      /* @__PURE__ */ _(Fragment_default, { team: "explore", name: "header" }),
      /* @__PURE__ */ _(
        D3,
        { url: path, onChange: updateData },
        /* @__PURE__ */ _(HomePage_default2, { path: "/", ...state }),
        /* @__PURE__ */ _(CategoryPage_default2, {
          path: "/products/:filter?",
          ...state,
        }),
        /* @__PURE__ */ _(StoresPage_default2, { path: "/stores", ...state }),
        /* @__PURE__ */ _(
          "div",
          { default: true },
          /* @__PURE__ */ _("h1", null, "404 Not Found ", path)
        )
      ),
      /* @__PURE__ */ _(Fragment_default, { team: "explore", name: "footer" })
    );
  };
  var App_default = App;
  ...
  preact_custom_element_esm_default(HeaderCe_default, "explore-header", null, {
    shadow: true,
  });
  preact_custom_element_esm_default(FooterCe_default, "explore-footer", null, {
    shadow: true,
  });
  preact_custom_element_esm_default(
    RecommendationsCe_default,
