(() => {
  ...
  function P() {
    var n2, u4, t3, o3, r4, e3, c6, s6;
    for (i.sort(f); n2 = i.shift(); ) n2.__d && (u4 = i.length, o3 = void 0, e3 = (r4 = (t3 = n2).__v).__e, c6 = [], s6 = [], t3.__P && ((o3 = d({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(o3), O(t3.__P, o3, r4, t3.__n, t3.__P.namespaceURI, 32 & r4.__u ? [e3] : null, c6, null == e3 ? x(r4) : e3, !!(32 & r4.__u), s6), o3.__v = r4.__v, o3.__.__k[o3.__i] = o3, j(c6, o3, s6), o3.__e != e3 && C(o3)), i.length > u4 && i.sort(f));
    P.__r = 0;
  }
  function S(n2, l5, u4, t3, i4, o3, r4, f3, e3, c6, s6) {
    var a5, v4, y4, d4, w4, _3 = t3 && t3.__k || p, g3 = l5.length;
    for (u4.__d = e3, $(u4, l5, _3), e3 = u4.__d, a5 = 0; a5 < g3; a5++) null != (y4 = u4.__k[a5]) && "boolean" != typeof y4 && "function" != typeof y4 && (v4 = -1 === y4.__i ? h : _3[y4.__i] || h, y4.__i = a5, O(n2, y4, v4, i4, o3, r4, f3, e3, c6, s6), d4 = y4.__e, y4.ref && v4.ref != y4.ref && (v4.ref && N(v4.ref, null, y4), s6.push(y4.ref, y4.__c || d4, y4)), null == w4 && null != d4 && (w4 = d4), 65536 & y4.__u || v4.__k === y4.__k ? (e3 && !e3.isConnected && (e3 = x(v4)), e3 = I(y4, e3, n2)) : "function" == typeof y4.type && void 0 !== y4.__d ? e3 = y4.__d : d4 && (e3 = d4.nextSibling), y4.__d = void 0, y4.__u &= -196609);
    u4.__d = e3, u4.__e = w4;
  }
  function $(n2, l5, u4) {
    var t3, i4, o3, r4, f3, e3 = l5.length, c6 = u4.length, s6 = c6, a5 = 0;
    for (n2.__k = [], t3 = 0; t3 < e3; t3++) r4 = t3 + a5, null != (i4 = n2.__k[t3] = null == (i4 = l5[t3]) || "boolean" == typeof i4 || "function" == typeof i4 ? null : "string" == typeof i4 || "number" == typeof i4 || "bigint" == typeof i4 || i4.constructor == String ? g(null, i4, null, null, null) : y(i4) ? g(k, { children: i4 }, null, null, null) : void 0 === i4.constructor && i4.__b > 0 ? g(i4.type, i4.props, i4.key, i4.ref ? i4.ref : null, i4.__v) : i4) ? (i4.__ = n2, i4.__b = n2.__b + 1, f3 = L(i4, u4, r4, s6), i4.__i = f3, o3 = null, -1 !== f3 && (s6--, (o3 = u4[f3]) && (o3.__u |= 131072)), null == o3 || null === o3.__v ? (-1 == f3 && a5--, "function" != typeof i4.type && (i4.__u |= 65536)) : f3 !== r4 && (f3 === r4 + 1 ? a5++ : f3 > r4 ? s6 > e3 - r4 ? a5 += f3 - r4 : a5-- : f3 < r4 ? f3 == r4 - 1 && (a5 = f3 - r4) : a5 = 0, f3 !== t3 + a5 && (i4.__u |= 65536))) : (o3 = u4[r4]) && null == o3.key && o3.__e && 0 == (131072 & o3.__u) && (o3.__e == n2.__d && (n2.__d = x(o3)), V(o3, o3, false), u4[r4] = null, s6--);
    if (s6) for (t3 = 0; t3 < c6; t3++) null != (o3 = u4[t3]) && 0 == (131072 & o3.__u) && (o3.__e == n2.__d && (n2.__d = x(o3)), V(o3, o3));
  }
  function I(n2, l5, u4) {
    var t3, i4;
  ...
  function O(n2, u4, t3, i4, o3, r4, f3, e3, c6, s6) {
    var a5, h4, p5, v4, w4, _3, g3, m3, x2, C4, M3, P3, $3, I3, H2, L2 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t3.__u && (c6 = !!(32 & t3.__u), r4 = [e3 = u4.__e = t3.__e]), (a5 = l.__b) && a5(u4);
    n: if ("function" == typeof L2) try {
      if (m3 = u4.props, x2 = (a5 = L2.contextType) && i4[a5.__c], C4 = a5 ? x2 ? x2.props.value : a5.__ : i4, t3.__c ? g3 = (h4 = u4.__c = t3.__c).__ = h4.__E : ("prototype" in L2 && L2.prototype.render ? u4.__c = h4 = new L2(m3, C4) : (u4.__c = h4 = new b(m3, C4), h4.constructor = L2, h4.render = q), x2 && x2.sub(h4), h4.props = m3, h4.state || (h4.state = {}), h4.context = C4, h4.__n = i4, p5 = h4.__d = true, h4.__h = [], h4._sb = []), null == h4.__s && (h4.__s = h4.state), null != L2.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, L2.getDerivedStateFromProps(m3, h4.__s))), v4 = h4.props, w4 = h4.state, h4.__v = u4, p5) null == L2.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
      else {
        if (null == L2.getDerivedStateFromProps && m3 !== v4 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m3, C4), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m3, h4.__s, C4) || u4.__v === t3.__v)) {
        ...
        null != h4.componentWillUpdate && h4.componentWillUpdate(m3, h4.__s, C4), null != h4.componentDidUpdate && h4.__h.push(function() {
          h4.componentDidUpdate(v4, w4, _3);
        });
      }
      if (h4.context = C4, h4.props = m3, h4.__P = n2, h4.__e = false, P3 = l.__r, $3 = 0, "prototype" in L2 && L2.prototype.render) {
  ...
  function z(l5, u4, t3, i4, o3, r4, f3, e3, c6) {
    var s6, a5, p5, v4, d4, _3, g3, m3 = t3.props, k4 = u4.props, b3 = u4.type;
    if ("svg" === b3 ? o3 = "http://www.w3.org/2000/svg" : "math" === b3 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != r4) {
      for (s6 = 0; s6 < r4.length; s6++) if ((d4 = r4[s6]) && "setAttribute" in d4 == !!b3 && (b3 ? d4.localName === b3 : 3 === d4.nodeType)) {
        l5 = d4, r4[s6] = null;
        break;
      }
    }
    ...
    if (null === b3) m3 === k4 || e3 && l5.data === k4 || (l5.data = k4);
      ...
      if (r4 = r4 && n.call(l5.childNodes), m3 = t3.props || h, !e3 && null != r4) for (m3 = {}, s6 = 0; s6 < l5.attributes.length; s6++) m3[(d4 = l5.attributes[s6]).name] = d4.value;
      for (s6 in m3) if (d4 = m3[s6], "children" == s6) ;
      else if ("dangerouslySetInnerHTML" == s6) p5 = d4;
      else if ("key" !== s6 && !(s6 in k4)) {
        if ("value" == s6 && "defaultValue" in k4 || "checked" == s6 && "defaultChecked" in k4) continue;
        A(l5, s6, null, d4, o3);
      }
      for (s6 in k4) d4 = k4[s6], "children" == s6 ? v4 = d4 : "dangerouslySetInnerHTML" == s6 ? a5 = d4 : "value" == s6 ? _3 = d4 : "checked" == s6 ? g3 = d4 : "key" === s6 || e3 && "function" != typeof d4 || m3[s6] === d4 || A(l5, s6, d4, m3[s6], o3);
      if (a5) e3 || p5 && (a5.__html === p5.__html || a5.__html === l5.innerHTML) || (l5.innerHTML = a5.__html), u4.__k = [];
      else if (p5 && (l5.innerHTML = ""), S(l5, y(v4) ? v4 : [v4], u4, t3, i4, "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o3, r4, f3, r4 ? r4[0] : t3.__k && x(t3, 0), e3, c6), null != r4) for (s6 = r4.length; s6--; ) null != r4[s6] && w(r4[s6]);
      e3 || (s6 = "value", void 0 !== _3 && (_3 !== l5[s6] || "progress" === b3 && !_3 || "option" === b3 && _3 !== m3[s6]) && A(l5, s6, _3, m3[s6], o3), s6 = "checked", void 0 !== g3 && g3 !== l5[s6] && A(l5, s6, g3, m3[s6], o3));
    }
    return l5;
  }
  function N(n2, u4, t3) {
  ...
  function s2() {
    ...
    this.dispatchEvent(o3), this._vdom = _(a2, r2({}, this._props, { context: o3.detail.context }), function e3(n2, o4) {
      ...
      var r4 = [], i4 = {}, a5 = 0, s6 = n2.attributes, l5 = n2.childNodes;
      for (a5 = s6.length; a5--; ) "slot" !== s6[a5].name && (i4[s6[a5].name] = s6[a5].value, i4[c2(s6[a5].name)] = s6[a5].value);
      for (a5 = l5.length; a5--; ) {
  ...
  var Navigation = ({ avg }) => {
    return /* @__PURE__ */ _("nav", null, /* @__PURE__ */ _("a", { href: "/checkout/about" }, "About"), /* @__PURE__ */ _("a", { href: "/checkout/contact" }, "Contact"), /* @__PURE__ */ _("a", { href: "/checkout/faq" }, "FAQ"), /* @__PURE__ */ _("p", null, "Average: ", avg));
  };
    ...
    if (o3.t = n2, !o3.__c && (o3.__ = [i4 ? i4(u4) : D2(void 0, u4), function(n3) {
      ...
      var f3 = function(n3, t3, r4) {
        ...
        if (u5.every(function(n4) {
          return !n4.__N;
        })) return !c6 || c6.call(this, n3, t3, r4);
        var i5 = false;
        ...
        }), !(!i5 && o3.__c.props === n3) && (!c6 || c6.call(this, n3, t3, r4));
      };
      r3.u = true;
      var c6 = r3.shouldComponentUpdate, e3 = r3.componentWillUpdate;
      r3.componentWillUpdate = function(n3, t3, r4) {
        if (this.__e) {
          var u5 = c6;
          c6 = void 0, f3(n3, t3, r4), c6 = u5;
        }
  ...
  function P2(n2) {
    var u4 = r3.context[n2.__c], i4 = h2(t2++, 9);
  ...
  async function fetchFragmentData(name, query) {
    if (name === "navigation") {
      return api("/navigation", { query });
    }
  }

  // src/fragments/NavigationCe.jsx
  var NavigationCe = ({ min, max }, initialState) => {
    ...
    _2(async () => {
      if (isInitialRender.current && state.avg !== void 0) {
    ...
    return /* @__PURE__ */ _(Navigation_default, { ...state });
  };
  NavigationCe.propTypes = {
    min: Number,
    max: Number
  };
  var NavigationCe_default = NavigationCe;
  ...
  function s4(n2, t3, r4) {
    ...
    if (e3 && e3[1]) for (var f3 = e3[1].split("&"), c6 = 0; c6 < f3.length; c6++) {
      var s6 = f3[c6].split("=");
      u4[decodeURIComponent(s6[0])] = decodeURIComponent(s6.slice(1).join("="));
    }
  ...
  function C3() {
    ...
    if (n2 === g2) {
      var t3 = p3()[1];
      _2(function() {
        return y3.push(t3), function() {
          return y3.splice(y3.indexOf(t3), 1);
        };
      }, []);
    }
    return [n2, $2];
  ...
  c4(D3.prototype = new b(), { shouldComponentUpdate: function(n2) {
    ...
    var e3, u4, f3 = n2.onChange, a5 = t3.url, s6 = this.c, h4 = this.g(H(n2.children), a5);
    if (h4 && (u4 = E(h4[0], c4(c4({ url: a5, matches: e3 = h4[1] }, e3), { key: void 0, ref: void 0 }))), a5 !== (s6 && s6.url)) {
      c4(g2, s6 = this.c = { url: a5, previous: s6 && s6.url, current: u4, path: u4 ? u4.props.path : null, matches: e3 }), s6.router = this, s6.active = u4 ? [u4] : [];
      for (var v4 = y3.length; v4--; ) y3[v4]({});
      "function" == typeof f3 && f3(s6);
    }
    return _(k3.Provider, { value: s6 }, u4);
  } });
  var E2 = function(n2) {
    return _("a", c4({ onClick: W }, n2));
  };

  // node_modules/preact-router/match/index.mjs
  var s5 = ["className", "activeClass", "activeClassName", "path"];
  function c5(l5) {
    var c6 = l5.className, n2 = l5.activeClass, u4 = l5.activeClassName, i4 = l5.path, p5 = function(a5, t3) {
      if (null == a5) return {};
      var r4, e3, s6 = {}, l6 = Object.keys(a5);
      for (e3 = 0; e3 < l6.length; e3++) t3.indexOf(r4 = l6[e3]) >= 0 || (s6[r4] = a5[r4]);
      return s6;
    }(l5, s5), h4 = C3()[0], f3 = i4 && h4.path && s4(h4.path, i4, {}) || s4(h4.url, p5.href, {}), o3 = p5.class || c6 || "", m3 = f3 && (n2 || u4) || "";
    return p5.class = o3 + (o3 && m3 && " ") + m3, _(E2, p5);
  }

  // src/pages/About.module.css
  var result = { "headline": "ex_headline--h95eb", "headlineSpecial": "ex_headlineSpecial--he64a", "a--b": "ex_a--b--hda9c" };
  var About_default = result;
  ...
  // src/pages/About.jsx
  var About = ({ title, content }) => {
    const [counter, setCounter] = p3(0);
    const [min, setMin] = p3(100);
    const [max, setMax] = p3(110);
    let classes = About_default.headline;
    if (counter >= 10) {
      classes += " " + About_default.headlineSpecial;
    }
    return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("h2", null, "About Page"), /* @__PURE__ */ _("h1", { class: classes }, title), /* @__PURE__ */ _("pre", null, JSON.stringify(About_default)), /* @__PURE__ */ _("p", null, content), /* @__PURE__ */ _("p", null, "Counter: ", counter), /* @__PURE__ */ _("button", { onClick: () => setCounter(counter + 1) }, "+1"), /* @__PURE__ */ _("hr", null), /* @__PURE__ */ _("p", null, "Range: ", min, "-", max), /* @__PURE__ */ _("button", { onClick: () => setMin(min + 1) }, "min +1"), /* @__PURE__ */ _("button", { onClick: () => setMax(max + 1) }, "max +1"), /* @__PURE__ */ _(Fragment_default, { team: "checkout", name: "navigation", min, max })));
  };
  var About_default2 = About;

  // src/pages/Stores.jsx
  var Stores = (props) => {
    return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("h2", null, "Stores Page"), /* @__PURE__ */ _("pre", null, JSON.stringify(props)));
  };
  var Stores_default = Stores;

  // src/App.jsx
  var App = ({ path, data }) => {
    return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("nav", null, /* @__PURE__ */ _(c5, { href: "/checkout" }, "Home"), /* @__PURE__ */ _(c5, { href: "/checkout/about" }, "About"), /* @__PURE__ */ _(c5, { href: "/checkout/stores" }, "Stores")), /* @__PURE__ */ _(D3, { url: path }, /* @__PURE__ */ _("div", { path: "/checkout" }, /* @__PURE__ */ _("h1", null, "Checkout Home")), /* @__PURE__ */ _(About_default2, { path: "/checkout/about", ...data }), /* @__PURE__ */ _(Stores_default, { path: "/checkout/stores", ...data }), /* @__PURE__ */ _("div", { default: true }, /* @__PURE__ */ _("h1", null, "404 Not Found ", path))));
  };
  var App_default = App;
  ...
  preact_custom_element_esm_default(NavigationCe_default, "checkout-navigation", null, { shadow: true });
})();
